...
public interface Betting {
	 ...
	 *         </ul>
	 */
	List<List<String>> listPlayers(String managerPwd)
			throws AuthenticationException;
	 ...
	 */
	void creditPlayer(String username, long numberTokens, String managerPwd)
			throws AuthenticationException, ExistingPlayerException,
			BadParametersException;
	 ...
	 * 
	 */
	void debitPlayer(String username, long numberTokens, String managerPwd)
			throws AuthenticationException, ExistingPlayerException,
	 ...
	 */
	ArrayList<String> infosPlayer(String username, String pwdSubs)
			throws AuthenticationException;

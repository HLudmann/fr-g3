...
public class SettlePodiumValidationTests {
	...
	public SettlePodiumValidationTests() {
		...
		System.out.print("  ----- Solder podium sur une comp�tition ? (y/n)\n");
		c = getResponse();
		if (c.equals("y")) {
			this.setUp();
		...
		System.out
				.print("  ----- Solder podium avec des �quipes sur une comp�tition ?(y/n)\n");
		c = getResponse();
		if (c.equals("y")) {
			this.setUpTeam();
	...
	private void testWithNullParameters() {
		...
		try {
			...
			System.out
					.println("solder podium d'une comp�tition avec aucun param�tre instanci� n'a pas lev� d'exception ");
		} catch (Exception e) {
		}
		try {
			increment.getBetting().settlePodium(new String("a_compet"), null,
					null, null, null);
			System.out
					.println("solder podium d'une comp�tition connue, tous les autres param�tres non instanci�s n'a pas lev� d'exception ");
		} catch (Exception e) {
		}
		...
		try {
			increment.getBetting().settlePodium(new String("a_compet"), winner,
					null, null, null);
			System.out
					.println("solder podium d'une comp�tition avec second, troisi�me mdp gestionnaire non instanci�s n'a pas lev� d'exception ");
		} catch (Exception e) {
		}
		...
		try {
			increment.getBetting().settlePodium(new String("a_compet"), null,
					second, null, null);
			System.out
					.println("solder podium d'une comp�tition avec premier, troisi�me et mdp gestionnaire non instanci�s n'a pas lev� d'exception ");
		} catch (Exception e) {
		}
		try {
			increment.getBetting().settlePodium(new String("a_compet"), null,
					null, third, null);
			System.out
					.println("solder podium d'une comp�tition avec premier, second et mdp gestionnaire non instanci�s n'a pas lev� d'exception ");
		} catch (Exception e) {
		}
		try {
			increment.getBetting().settlePodium(new String("a_compet"), winner,
					null, third, null);
			System.out
					.println("solder podium d'une comp�tition avec second et mdp gestionnaire non instanci�s n'a pas lev� d'exception ");
		} catch (Exception e) {
		}
		try {
			...
			System.out
					.println("solder podium d'une comp�tition avec comp�tition, second et mdp gestionnaire non instanci�s n'a pas lev� d'exception ");
		} catch (Exception e) {
		}
		try {
			increment.getBetting().settlePodium(null, winner, second, third,
					null);
			System.out
					.println("solder podium d'une comp�tition avec comp�tition et mdp gestionnaire non instanci�s n'a pas lev� d'exception ");
		} catch (Exception e) {
		}
		try {
			increment.getBetting().settlePodium(new String("a_compet"), winner,
					second, third, null);
			System.out
					.println("solder podium d'une comp�tition avec mdp gestionnaire non instanci� n'a pas lev� d'exception ");
		} catch (Exception e) {
		}
	...
	private void testWithInvalidParameters() {
		...
		try {
			...
			System.out
					.println("solder podium d'une comp�tition avec mdp gestionnaire incorrect n'a pas lev� d'exception ");
		} catch (Exception e) {
		}
		try {
			...
			System.out
					.println("solder podium d'une comp�tition avec comp�tition inconnue n'a pas lev� d'exception ");
		} catch (Exception e) {
		}
		try {
		...
		try {
			...
			System.out
					.println("solder podium d'une comp�tition avec podium invalide (r�p�titions) n'a pas lev� d'exception ");
		} catch (Exception e) {
		}
		try {
			increment.getBetting().settlePodium(new String("a_compet"), winner,
		...
		try {
			...
			System.out
					.println("solder podium d'une comp�tition qui est encore ouverte n'a pas lev� d'exception ");
		} catch (Exception e) {
		}
	}
	...
	private void testOK() {
		try {
			...
			System.out
					.println("Solder podium valide (Duranto,Durant,Duranti) a lev� l'exception "
							+ e.getMessage());
		}
	...
	private void testTeamOK() {
		try {
			...
			System.out.println("Solder podium valide a lev� l'exception "
					+ e.getClass());
		}

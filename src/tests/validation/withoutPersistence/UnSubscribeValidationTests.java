...
public class UnSubscribeValidationTests {
	...
	private void testUnsubscribeNullParameters() {
		try {
			increment.getBetting().unsubscribe(null,
					increment.getManagerPassword());
			System.out
					.println("retirer un joueur avec un pseudo non instanci� et mdp gestionnaire correct n'a pas lev� d'exception ");
		} catch (Exception e) {
		}
		try {
			increment.getBetting().unsubscribe(new String("fanfan"), null);
			System.out
					.println("retirer un joueur avec un pseudo connu et mdp gestionnaire non instanci� n'a pas lev� d'exception ");
		} catch (Exception e) {
		}
	}
	...
	private void testUnsubscribeInvalidParameters() {
		...
		try {
			increment.getBetting().unsubscribe(new String(" "),
					increment.getManagerPassword());
			System.out
					.println("retirer un joueur avec un pseudo invalide (\" \") et un mdp correct n'a pas lev� d'exception ");
		} catch (Exception e) {
		}
		...
		try {
			increment.getBetting().unsubscribe(new String("fanfan"),
					new String(" "));
			System.out
					.println(" retirer un joueur avec un pseudo connu et un mdp gestionnaire invalide (\" \") n'a pas lev� d'exception ");
		} catch (Exception e) {
		}
		...
		try {
			increment.getBetting().unsubscribe(new String("fanfan"),
					new String("jki"));
			System.out
					.println(" retirer un joueur avec un pseudo connu et un mdp gestionnaire invalide (\"jki\") n'a pas lev� d'exception ");
		} catch (Exception e) {
		}
	}
	...
	private void testUnsubscribeUsernameNotExist() {
		try {
			increment.getBetting().unsubscribe(new String("lolita"),
					increment.getManagerPassword());
			System.out
					.println("un joueur a �t� retir� (lolita) alors qu'il n'�tait pas inscrit ");
		} catch (Exception e) {
		}
	}
	...
	private void testUnsubscribeOK() {
		...
		try {
			...
			System.out
					.println("retirer un joueur inscrit (fanfin) a lev� l'exception "
							+ e.getClass());
		}
		...
		if (c.equals("y")) {
			...
			try {
				...
				System.out
						.println("retirer un joueur inscrit (fanfan) a lev� l'exception "
								+ e.getClass());
			}
		}
	}
